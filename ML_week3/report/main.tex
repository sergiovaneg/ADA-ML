...
\section{Recursive Models}
  ...
  \subsection{Simple Recursive Neural Network}
    ...
    The model training yields the results in \Cref{fig:rnn_fit}, with a forecast RMSE of $1.223$ and a MAE of $3.396$. 
  ...
  \subsection*{LSTM Neural Network}
    ...
    The model training yields the results in \Cref{fig:lstm_fit}, with a forecast RMSE of $1.195$ and a MAE of $2.968$.
